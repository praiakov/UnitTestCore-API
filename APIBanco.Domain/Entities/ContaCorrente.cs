namespace APIBanco.Domain.Entities
{
    public class ContaCorrente
    {
        ...
        private bool TemLimite(decimal valor) => Limite >= valor;

        private bool TemSaldo(decimal valor) => Saldo >= valor;

        public bool PodeTransferir(decimal valor) =>  TemLimite(valor) && TemSaldo(valor);
